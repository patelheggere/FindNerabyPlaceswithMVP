package com.patelheggere.goldfarm.view.hotel;
...
public class HotelFragment extends BaseFragment implements OnMapReadyCallback,
...
public void onClick(View v) {
        showProgressBar();
        mRestPresenter.getDetails("lodging", latitude, longitude);
        }
        });
...
public void noResults() {
        Toast.makeText(mActivity, "Not found any Hotel near by you ", Toast.LENGTH_LONG).show();
        }
