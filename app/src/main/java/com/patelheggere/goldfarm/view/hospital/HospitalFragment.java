package com.patelheggere.goldfarm.view.hospital;
...
public class HospitalFragment extends BaseFragment implements OnMapReadyCallback,
    ...
    private RestFragment.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                showProgressBar();
                mRestPresenter.getDetails("hospital", latitude, longitude);
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof RestFragment.OnFragmentInteractionListener) {
            mListener = (RestFragment.OnFragmentInteractionListener) context;
        } else {
    ...
    public void noResults() {
        Toast.makeText(mActivity, "Not found any Hospital near by you ", Toast.LENGTH_LONG).show();
    }
